...
def test_3_qtimer_setup():
    ...
    print("\n  ✓ main_window.py:216 - 3초 타이머 설정 확인")
    ...
    print("  ✓ update_manager.py:108 - 3초 타이머 설정 확인")
...
def test_4_worker_signal_connections():
    ...
    print("  ✓ update_available 시그널 존재")
    print("  ✓ no_update 시그널 존재")
    print("  ✓ check_failed 시그널 존재")
    ...
    print("  ✓ update_available → _on_update_available 연결 확인")
    print("  ✓ no_update → _on_no_update_auto/_on_no_update_manual 연결 확인")
    print("  ✓ check_failed → _on_check_failed 연결 확인")
...
def test_5_integration_check():
    ...
    print("  ✓ Container 초기화")
    print("  ✓ initialize_update_services() 호출")
    print("  ✓ update_manager = UpdateManager(...)")
    print("  ✓ window.set_update_manager(update_manager)")
    ...
    print("  ✓ set_update_manager(update_manager)")
    print("  ✓ QTimer.singleShot(3000, self._check_for_updates_on_startup)")
    print("  ✓ _check_for_updates_on_startup() → update_manager.check_for_updates_on_startup()")
    ...
    print("  ✓ check_for_updates_on_startup()")
    print("  ✓ scheduler.should_check_on_startup() 확인")
    print("  ✓ QTimer.singleShot(3000, self._start_auto_check)")
    print("  ✓ UpdateCheckWorker 생성 및 시작")
    print("  ✓ 시그널 처리")
...
def run_all_tests():
    ...
    try:
        ...
        print("\n[검증 결론]")
        print("  ✓ UpdateManager가 MainWindow에 올바르게 주입됨")
        print("  ✓ 앱 시작 3초 후 자동 체크 시작 (main_window.py)")
        print("  ✓ 추가로 3초 타이머가 있어 총 6초 후 체크 (update_manager.py)")
        print("  ✓ 24시간 간격 로직이 올바르게 작동")
        print("  ✓ Worker 시그널이 올바르게 연결됨")
        print("  ✓ 전체 통합 흐름이 정상 작동")
